...
language_data = {
    "english": {
        "description": """
        ### 🎥 **Translate videos easily with Aravind_MSD_Translater!** 📽️

        Upload a video, subtitle, audio file or provide a URL video link. 📽️ **Gets the updated notebook from the official repository.: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater supports different TTS (Text-to-Speech) engines, which are:**
    ...
    "spanish": {
        "description": """
        ### 🎥 **¡Traduce videos fácilmente con Aravind_MSD_Translater!** 📽️

        Sube un video, audio o proporciona un enlace de YouTube. 📽️ **Obtén el cuaderno actualizado desde el repositorio oficial: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater admite diferentes motores de TTS (Texto a Voz), los cuales son:**
    ...
    "french": {
        "description": """
        ### 🎥 **Traduisez facilement les vidéos avec Aravind_MSD_Translater !** 📽️

        Téléchargez une vidéo, un fichier audio ou fournissez un lien YouTube. 📽️ **Obtenez le notebook mis à jour à partir du référentiel officiel : [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater prend en charge différents moteurs TTS (Text-to-Speech), à savoir :**
    ...
    "german": {
        "description": """
        ### 🎥 **Übersetzen Sie Videos einfach mit Aravind_MSD_Translater!** 📽️

        Laden Sie ein Video, eine Audiodatei hoch oder geben Sie einen YouTube-Link an. 📽️ **Holen Sie sich das aktualisierte Notizbuch aus dem offiziellen Repository: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater unterstützt verschiedene TTS (Text-to-Speech)-Engines, darunter:**
    ...
    "italian": {
        "description": """
        ### 🎥 **Traduci i video facilmente con Aravind_MSD_Translater!** 📽️

        Carica un video, un file audio o fornisci un link YouTube. 📽️ **Ottieni il notebook aggiornato dal repository ufficiale: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater supporta diversi motori TTS (Text-to-Speech), tra cui:**
    ...
    "japanese": {
        "description": """
        ### 🎥 **Aravind_MSD_Translaterで簡単に動画を翻訳しましょう！** 📽️

        動画、音声ファイルをアップロードするか、YouTubeのリンクを提供してください。📽️ **公式リポジトリから最新のノートブックを入手する: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_TranslaterはさまざまなTTS（テキスト読み上げ）エンジンをサポートしています。これらは次のとおりです:**
    ...
    "chinese_zh_cn": {
        "description": """
          ### 🎥 **使用Aravind_MSD_Translater轻松翻译视频！** 📽️

          上传视频、音频文件或提供YouTube链接。 📽️ **从官方存储库获取更新的笔记本：[Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        "tutorial": """
          ...
          # 🧩 **Aravind_MSD_Translater支持不同的TTS（文本到语音）引擎，包括:**
    ...
    "ukrainian": {
        "description": """
        ### 🎥 **Перекладайте відео легко з Aravind_MSD_Translater!** 📽️

        Завантажте відео, аудіофайл або надайте посилання на YouTube. 📽️ **Отримайте оновлений ноутбук з офіційного репозиторію: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater підтримує різні двигуни TTS (текст-у-мову), які є:**
    ...
    "arabic": {
        "description": """
          ### 🎥 **ترجمة مقاطع الفيديو بسهولة مع Aravind_MSD_Translater!** 📽️

          قم بتحميل ملف فيديو أو صوتي أو قدم رابطًا لفيديو YouTube. 📽️ **احصل على الدفتر المحدث من المستودع الرسمي: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        "tutorial": """
          ...
          # 🧩 **يدعم Aravind_MSD_Translater محركات TTS (نص إلى كلام) مختلفة، وهي:**
    ...
    "russian": {
        "description": """
        ### 🎥 **Перевод видео легко с Aravind_MSD_Translater!** 📽️

        Загрузите видео, аудиофайл или предоставьте ссылку на YouTube. 📽️ **Получите обновленный блокнот из официального репозитория.: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater поддерживает различные движки TTS (текст в речь), которые включают:**
    ...
    "turkish": {
        "description": """
        ### 🎥 **Aravind_MSD_Translater ile videoları kolayca çevirin!** 📽️

        Bir video yükleyin, ses dosyası ekleyin veya bir YouTube bağlantısı sağlayın. 📽️ **Güncellenmiş notebook'ı resmi depodan alın: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater, farklı TTS (Metin-okuma-sesi) motorlarını destekler, bunlar:**
    ...
    "indonesian": {
        "description": """
        ### 🎥 **Terjemahkan video dengan mudah menggunakan Aravind_MSD_Translater!** 📽️

        Unggah video, file audio, atau berikan tautan YouTube. 📽️ **Dapatkan buku catatan yang diperbarui dari repositori resmi: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater mendukung berbagai mesin TTS (Teks-ke-Suara), yaitu:**
    ...
    "portuguese": {
        "description": """
        ### 🎥 **Traduza vídeos facilmente com o Aravind_MSD_Translater!** 📽️

        Carregue um vídeo, arquivo de áudio ou forneça um link do YouTube. 📽️ **Obtenha o caderno atualizado do repositório oficial: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater suporta diferentes motores TTS (Texto para Fala), que são:**
    ...
    "hindi": {
        "description": """
          ### 🎥 **Aravind_MSD_Translater के साथ वीडियो को आसानी से अनुवादित करें!** 📽️

          एक वीडियो, ऑडियो फ़ाइल अपलोड करें या एक YouTube लिंक प्रदान करें। 📽️ **आधिकारिक भंडार से अपडेटेड नोटबुक प्राप्त करें: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        "tutorial": """
          ...
          # 🧩 **Aravind_MSD_Translater विभिन्न TTS (टेक्स्ट-टू-स्पीच) इंजनों का समर्थन करता है, जो हैं:**
    ...
    "vietnamese": {
        "description": """
        ### 🎥 **Dịch video dễ dàng với Aravind_MSD_Translater!** 📽️

        Tải lên một video, tập tin âm thanh hoặc cung cấp một liên kết YouTube. 📽️ **Nhận sổ tay cập nhật từ kho chính thức: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater hỗ trợ các công cụ TTS (Text-to-Speech) khác nhau, bao gồm:**
    ...
    "polish": {
        "description": """
        ### 🎥 **Łatwe tłumaczenie filmów dzięki Aravind_MSD_Translater!** 📽️

        Prześlij film, plik dźwiękowy lub podaj link do YouTube. 📽️ **Pobierz aktualny notatnik ze strony oficjalnego repozytorium: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater obsługuje różne silniki TTS (tekst do mowy), które to:**
    ...
    "swedish": {
        "description": """
        ### 🎥 **Översätt videor enkelt med Aravind_MSD_Translater!** 📽️

        Ladda upp en video, ljudfil eller ange en YouTube-länk. 📽️ **Få den uppdaterade anteckningsboken från det officiella arkivet: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater stöder olika TTS (Text-to-Speech) motorer, vilka är:**
    ...
    "korean": {
        "description": """
        ### 🎥 **Aravind_MSD_Translater를 사용하여 비디오를 쉽게 번역하세요!** 📽️

        비디오, 오디오 파일을 업로드하거나 YouTube 링크를 제공하세요. 📽️ **공식 저장소에서 최신 노트북을 받으세요.: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater는 다양한 TTS (텍스트 음성 변환) 엔진을 지원합니다. 이는 다음과 같습니다:**
    ...
    "marathi": {
        "description": """
        ### 🎥 **आसानीसोबत Aravind_MSD_Translater द्वारे व्हिडिओ अनुवाद करा!** 📽️

        एक व्हिडिओ, ऑडिओ फाईल अपलोड करा किंवा एक YouTube लिंक प्रदान करा. 📽️ **अद्यतनित नोटबुक घ्या आधिकृत भंडारात।: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater विविध TTS (पाठ-टू-स्पीच) इंजिनसाठी समर्थन करते, ज्या म्हणजे:**
    ...
    "azerbaijani": {
        "description": """
        ### 🎥 **Aravind_MSD_Translater ilə videoları asanlıqla tərcümə edin!** 📽️

        Video, səs faylı yükləyin və ya YouTube bağlantısı təqdim edin. 📽️ **Aravind_MSD_Translater-in rəsmi repositoriyasından yenilənmiş qeydləri alın: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater, fərqli TTS (Mətnə Səsləndirmə) mühərriklərini dəstəkləyir ki, onlar:**
    ...
    "persian": {
        "description": """
        ### 🎥 **با Aravind_MSD_Translater به راحتی ویدئوها را ترجمه کنید!** 📽️

        یک ویدئو، فایل زیرنویس، فایل صوتی را آپلود کنید یا یک لینک ویدئوی URL ارائه دهید. 📽️ **دفترچه یادداشت به‌روز شده را از مخزن رسمی دریافت کنید: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater از موتورهای مختلف TTS (متن به گفتار) پشتیبانی می‌کند، که شامل:**
    ...
    "afrikaans": {
        "description": """
        ### 🎥 **Vertaal video's maklik met Aravind_MSD_Translater!** 📽️

        Laai 'n video, onderskrif, klanklêer op of verskaf 'n URL-videolink. 📽️ **Kry die opgedateerde notaboek van die amptelike repository: [Aravind_MSD_Translater](https://github.com/R3gm/Aravind_MSD_Translater)!**
        ...
        # 🧩 **Aravind_MSD_Translater ondersteun verskillende TTS (Teks-na-Spraak) enjins, wat is:**
