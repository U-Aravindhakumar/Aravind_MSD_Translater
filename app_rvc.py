import gradio as gr
from Aravind_MSD_Translate.logging_setup import (
    logger,
    set_logging_level,
...
import torch
import os
from Aravind_MSD_Translate.audio_segments import create_translated_audio
from Aravind_MSD_Translate.text_to_speech import (
...
from Aravind_MSD_Translate.translate_segments import (
    translate_text,
    TRANSLATION_PROCESS_OPTIONS,
    DOCS_TRANSLATION_PROCESS_OPTIONS
)
from Aravind_MSD_Translate.preprocessor import (
    audio_video_preprocessor,
    audio_preprocessor,
)
from Aravind_MSD_Translate.postprocessor import (
    OUTPUT_TYPE_OPTIONS,
...
from Aravind_MSD_Translate.language_configuration import (
    LANGUAGES,
...
from Aravind_MSD_Translate.utils import (
    remove_files,
    download_list,
    upload_model_list,
    download_manager,
...
from Aravind_MSD_Translate.mdx_net import (
    UVR_MODELS,
    MDX_DOWNLOAD_LINK,
    mdxnet_models_dir,
)
from Aravind_MSD_Translate.speech_segmentation import (
    ASR_MODEL_OPTIONS,
    COMPUTE_TYPE_GPU,
    COMPUTE_TYPE_CPU,
    find_whisper_models,
...
from Aravind_MSD_Translate.text_multiformat_processor import (
    BORDER_COLORS,
...
from Aravind_MSD_Translate.languages_gui import language_data, news
import copy
import logging
import json
...
class Aravind_MSD_Translater(SoniTrCache):
    ...
    def multilingual_media_conversion(
        ...
        if not get_video_from_text_json:
            ...
            if not self.task_in_cache("refine_vocals", [vocal_refinement], {}):
                ...
                if vocal_refinement:
                    try:
                        from Aravind_MSD_Translate.mdx_net import process_uvr_task
        ...
        if not self.task_in_cache("acc_and_vc", [
            ...
            if voice_imitation:
                ...
                from Aravind_MSD_Translate.text_to_speech import toneconverter
...
title = "<center><strong><font size='7'>📽️ Aravind_MSD_Translater 🈷️</font></strong></center>"
...
if __name__ == "__main__":
    ...
    SoniTr = Aravind_MSD_Translater(cpu_mode=args.cpu_mode)
